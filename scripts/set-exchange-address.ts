...
task("prove-exchange-address", "Prove exchange address")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        const rx = await l2Provider.getTransactionReceipt("0xc7665b97cc6dc647ec77ab82f1ed8e117e611d7f6940ed1649af313404860cfb")
        ...
        const proofRes = await l2Provider.getMessageProof(
            rx.blockNumber,
        ...
        const isProofValid = await bridgehub.proveL2MessageInclusion(
            ...
            l2ToL1Log.logIndex,
            {
                ...
                data: ethers.utils.solidityPack(["bytes4", "address"], [l2SharedBridge.interface.getSighash("setExchangeAddress"), "0x80e51ac583e99ec0705cd51b5820e64d211bf617"])
            },
            proof
        )
