...
// keccak256("SetSubAccountMarginType(address subAccountID,uint8 marginType,uint32 nonce)");
...
// keccak256("AddSubAccountSigner(address subAccountID,address signer,uint16 permissions,uint32 nonce)");
...
// keccak256("SetSubAccountSignerPermissions(address subAccountID,address signer,uint64 permissions,uint32 nonce)");
...
// keccak256("RemoveSubAccountSigner(address subAccountID,address signer,uint32 nonce)");
...
// keccak256("AddSessionKey(address sessionKey,uint64 keyExpiry)");
