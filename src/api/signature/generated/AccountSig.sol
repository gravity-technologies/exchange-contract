...
// keccak256("AddAccountAdminPayload(uint32 accountID,address signer,uint32 nonce)");
...
bytes32 constant _DEL_ACC_ADMIN_H = keccak256("RemoveAccountAdminPayload(uint32 accountID,address signer,uint32 nonce)");
...
// keccak256("SetAccountMultiSigThresholdPayload(uint32 accountID,uint8 multiSigThreshold,uint32 nonce)");
bytes32 constant _SET_ACC_MULTISIG_THRESHOLD_H = bytes32(0xf02109d81822adc4631ca8f4de6649cd9f896b0ff41e1d70c785ab5595b64864);
...
// keccak256("AddWithdrawalAddressPayload(uint32 accountID,address withdrawalAddress,uint32 nonce)");
...
// keccak256("RemoveWithdrawalAddressPayload(uint32 accountID,address withdrawalAddress,uint32 nonce)");
...
// keccak256("AddTransferSubAccountPayload(uint32 accountID,address transferSubAccount,uint32 nonce)");
bytes32 constant _ADD_TRANSFER_SUB_ACCOUNT_H = bytes32(0xb7805997639b66d0086af76a62a08cc634d761a336b73c3a461ca55a36fc3127);
...
// keccak256("RemoveTransferSubAccountPayload(uint32 accountID,address transferSubAccount,uint32 nonce)");
